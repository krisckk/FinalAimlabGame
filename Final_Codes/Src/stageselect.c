...
static void Init(void){
	...
	stageselect -> StageselectThemsong = load_audio("Assets/Music/DreamIsCollapsing.ogg");
	play_bgm(stageselect ->StageselectThemsong, music_volume);
}
...
static void Destroy(void){
	...
	al_destroy_sample(stageselect -> StageselectThemsong);
}
...
static void On_mouse_down(){
	if(Firstsong.hovered && stamina > 0){
